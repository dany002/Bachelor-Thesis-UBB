...
# This method is used for live update
@api_view(['POST'])
@permission_classes([IsAuthenticated])
def get_records_with_bilstm_sql(request):
...
# This method is used to check the SQLi for a specific file using BI-LSTM
@api_view(['POST'])
@permission_classes([IsAuthenticated])
def check_file_sql_bilstm(request, file_id):
    data = json.loads(request.body)
